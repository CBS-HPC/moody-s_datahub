...
```bash
pip install https://github.com/CBS-HPC/moody-s_datahub/releases/download/v1.3.0/moodys_datahub-1.3.0-py3-none-any.whl
```
...
```bash
python -m build
pip install dist/moodys_datahub-1.3.0-py3-none-any.whl
```
